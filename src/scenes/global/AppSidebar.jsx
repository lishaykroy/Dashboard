            ...
            <ProSidebar collapsed={isCollapsed}>
                <Menu iconShape="square">
                    ...
                    <Box paddingLeft={isCollapsed ? undefined : "10%"}>
                        ...
                        <Typography variant="h6" color={colors.grey[300]} sx={{ m: "5px 0 5px 20px" }}>
                            Data
                        </Typography>
                        ...
                        <Item title="Line" to="/line" icon={<TimelineOutlinedIcon />}mselected={selected} setSelected={setSelected}/>
                        <Item title="Geography" to="/geography" icon={<MapOutlinedIcon />}mselected={selected} setSelected={setSelected}/>
                    </Box>
                </Menu>
            </ProSidebar>
        </Box>
